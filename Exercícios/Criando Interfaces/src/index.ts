...
async function main() {
    await fetchUser('MatheusLTrindade')
    await fetchUser('isaacpontes')
    await fetchUser('jrsantos1')
    await fetchUser('enoqueleal')
    await fetchUser('frans203')
    await fetchUser('MelvinAguilar')
    await fetchUser('lucasqueirogaa')

    await showUser('MatheusLTrindade')
    await showUser('jrsantos1')
